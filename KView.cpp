...
void KView::drawData(QPainter& painter)
{
	// get points
...
bool KView::sameSide(const QPoint& start, const QPoint& end) const
{
...
QPoint KView::jointPoint(const QPoint& start, const QPoint& end) const
{
...
QPoint KView::upper(const QPoint& start, const QPoint& end) const {
	return start.y() < end.y() ? start : end;
}

QPoint KView::lower(const QPoint& start, const QPoint& end) const {
	return start.y() > end.y() ? start : end;
}